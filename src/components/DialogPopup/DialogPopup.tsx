      ...
      <Dialog as='div' className='relative z-10' onClose={handleClose} initialFocus={completeButtonRef}>
        ...
        <div className='fixed inset-0 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <Dialog.Panel className={classNames('bg-white text-darkText relative', classNameWrapper)}>
                {children}
                <button
                  type='button'
                  className={classNames(
                    'absolute right-2 top-2 flex justify-center rounded-md p-2 text-sm font-medium text-darkText hover:text-red-600 ',
                    {
                      visible: closeButton,
