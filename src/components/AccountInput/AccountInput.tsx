      ...
      >
        <span className='absolute right-2 top-1/2 -translate-y-1/2'>
          <svg
            ...
            viewBox='0 0 24 24'
            fill='currentColor'
            className='h-4 w-4 fill-haretaColor duration-200 dark:fill-primarayBlue md:h-6 md:w-6'
          >
            {svgData}
          </svg>
        </span>
          ...
          >
            ...
            {!visible && (
              <svg
                ...
                viewBox='0 0 24 24'
                fill='currentColor'
                className='h-4 w-4 fill-primarayBlue/60 hover:fill-primarayBlue md:h-6 md:w-6'
              >
